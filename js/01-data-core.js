...
function dragonVisual(speciesId, level){
  ...
  const src=`images/${speciesId}_${stage}.webp?v=3.0.0`;
...
const SPECIES = [
  ...
  {id:'voidmaw',name:'Бездномор',  sigil:'🌑', el:'shade', rarity:5, hp:92, atk:22, def:10, spd:13, traits:['Беззвёздная пасть','Эхо пустоты'], lore:'Миф из мифов. Говорят, он старше самих гор.'},
  ...
  {id:'worldserpent',name:'Мирозмей',sigil:'🐉', el:'venom', rarity:5, hp:96, atk:18, def:15, spd:8,  traits:['Кольца мира','Яд первотворения'], lore:'Сказывают, его тело опоясывает корни всех земель.'},
];
