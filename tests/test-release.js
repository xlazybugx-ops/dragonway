...
const files=['js/00-balance.js','js/01-data-core.js','js/02-data-content.js','js/03-state.js','js/04-systems.js','js/08-battle.js'];
...
assert(T.GB.Release.version==='2.1.0-test','release version');
